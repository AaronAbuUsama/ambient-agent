...
const whatsappSkill = readFileSync(new URL("../../../agents/src/ambience/skills/whatsapp-participation/SKILL.md", import.meta.url), "utf8");
const issueSkill = readFileSync(new URL("../../../agents/src/ambience/skills/issue-management/SKILL.md", import.meta.url), "utf8");
