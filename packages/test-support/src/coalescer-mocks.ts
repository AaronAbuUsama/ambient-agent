...
import type { CoalescerEvent, ConversationWindow } from "../../engine/src/coalescer/events.ts";
import { EventSource, WindowDispatcher, WindowStore } from "../../engine/src/coalescer/ports.ts";
