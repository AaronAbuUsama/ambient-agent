...
the Brain may open a DM only by selecting a Person whose WhatsApp identity trusted code
resolves. The model never supplies a raw JID.
...
- Discovery as authorization or Brain-opened groups.
