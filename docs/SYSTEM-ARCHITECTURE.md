...
| **Brain**                           | Single global mind: up-inbox, two clocks, owns state + work                            | The reactive global actor claims immutable mixed Intents and Knowledge Deltas in one Batch frontier, serializes duplicate wakes, owns Graph lookup/rulings, records prompt/silence effects, recovers pending delivery, and wakes the next Batch (`brain/*`). It does not yet own GitHub routing/work or proactive time                                                                                                                                                                                                                                                                                                                                                                                                                     | **Move routing and work-dispatch onto the Brain; add the proactive clock**                                                     |
...
clock, reactive Brain conversation/knowledge loop, asynchronous delegation with durable return,
