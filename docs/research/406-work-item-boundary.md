...
| Open Loop | The derived condition that Attention, Work, or a Commitment remains unresolved. [`CONTEXT.md` — Information and accountability](../../CONTEXT.md#information-and-accountability) | A projection is not another mutable ledger or Entity. Persisting it would create synchronization debt with the states from which it is derived. |
...
[`SYSTEM-ARCHITECTURE.md` — The Brain](../SYSTEM-ARCHITECTURE.md#32-the-brain-master-agent),
[`SYSTEM-ARCHITECTURE.md` — Work](../SYSTEM-ARCHITECTURE.md#7-work--everything-routes-through-the-brain).
...
ontology to eleven Entity types. [`CONTEXT.md` — Shared graph](../../CONTEXT.md#shared-graph),
